...
{
	static const std::vector<std::string> FENTestsStrVector =
	{
...
const std::vector<std::string>& TestsUtilities::getFENTests()
{
	return testHelpers::FENTestsStrVector;
}

TestsUtilities::FENTestParams::FENTestParams(const std::string& testStr)
{
	const auto splitStr = CommonUtilities::splitString(testStr, ';');
